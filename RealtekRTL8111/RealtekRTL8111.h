...
#ifndef RealtekRTL8111H
#define RealtekRTL8111H
...
#define kMACAddrName "IOMACAddress"
...
public:
    ...
    UInt16 mClientCount;
    bool mErrFlag;
    RTL8111Client *mClientPtr[MAXUSERS+1];
    ...
    virtual void closeChild(RTL8111Client *ptr);
    virtual IOEthernetAddress GetOrigMACAddr(void);
    virtual void SetIsCustomMACAddr(Boolean used);
    virtual bool MergeDictionaryIntoProvider(IOService * provider, OSDictionary * dictionaryToMerge);
    virtual bool MergeDictionaryIntoDictionary(OSDictionary * parentSourceDictionary,  OSDictionary * parentTargetDictionary);
    
private:
    IOService *cardprovider;
    ...
    /* RTL8111X/8168X show MAC hardware address function */
    void ShowMacAddr(const IOEthernetAddress HWAddr);
...
private:
    ...
    /* Emulated MAC address */
    struct IOEthernetAddress emuMacAddr;
    Boolean emuMacAddrUsed;
